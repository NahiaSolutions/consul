class UsersController < ApplicationController
  ...
  private
    ...
    def load_volunteerings
      @volunteeringsUser = VoluntUser.where(:id_user => current_user.id)
      @volunteeringsPrograms = VoluntProgram.all()
    end

    #Actividad Casa Somos
    def load_houses
      @workshopsUser = WorkshopUser.where(:id_user => current_user.id)
