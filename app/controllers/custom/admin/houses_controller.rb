class Admin::HousesController < Admin::BaseController
    ...
    def create
        ...
        if @house.save
          redirect_to admin_zonal_administration_path(@zonalAdministration.id), notice: "Casa creada"
        else
          render :new
        end
    end
    ...
    def update
        ...
        if @house.update(house_params)
          redirect_to admin_zonal_administration_path(@zonalAdministration.id), notice: "casa actualizada"
        else
          render :edit
        end
    end
    ...
    def destroy
        ...
        redirect_to admin_zonal_administration_path(@zonalAdministration.id), notice: "Casa eliminada"
    end
