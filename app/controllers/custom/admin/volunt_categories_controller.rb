class Admin::VoluntCategoriesController < Admin::BaseController
    ...
    def create
        ...
        if @volunt_category.save
          redirect_to admin_volunt_categories_path, notice: "Categoría creada"
        else
          render :new
        end
    end
    ...
    def update
        ...
        if @volunt_category.update(category_params)
          redirect_to admin_volunt_categories_path, notice: "Categoría actualizada"
        else
          render :edit
        end
    end
    ...
    def destroy
        ...
        redirect_to admin_volunt_categories_path, notice: "Categoría eliminada"
    end
