class Admin::HousesAgeRangesController < Admin::BaseController
    ...
    def create
        ...
        if @ageRange.save
          redirect_to admin_houses_age_ranges_path, notice: "Edad creada"
        else
          render :new
        end
    end
    ...
    def update
        ...
        if @ageRange.update(age_params)
          redirect_to admin_houses_age_ranges_path, notice: "Edad actualizada"
        else
          render :edit
        end
    end
