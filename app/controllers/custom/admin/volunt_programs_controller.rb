class Admin::VoluntProgramsController < Admin::BaseController
    ...
    def create
        ...
        if @volunt_program.save
          redirect_to admin_volunt_category_path(@volunt_category),
    ...
    def update
        ...
        if @volunt_program.update(program_params)
          redirect_to admin_volunt_category_path(@volunt_category), notice: "Programa actualizado"
        else
          render :edit
        end
    end
