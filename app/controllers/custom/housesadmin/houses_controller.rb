class Housesadmin::HousesController < Housesadmin::BaseController
    ...
    def create
        ...
        if @house.save
          redirect_to housesadmin_zonal_administration_path(@zonalAdministration), notice: "Casa creada"
        else
          render :new
        end
    end
    ...
    def update
        ...
        if @house.update(house_params)
          redirect_to housesadmin_zonal_administration_path(@zonalAdministration), notice: "casa actualizada"
        else
          render :edit
        end
    end
    ...
    def destroy
        ...
        redirect_to housesadmin_zonal_administration_path(@zonalAdministration), notice: "Casa eliminada"
    end
