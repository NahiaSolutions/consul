class Housesadmin::HouseImagesController < Housesadmin::BaseController
    ...
    def create
        ...
        if @houseImage.save
          redirect_to housesadmin_zonal_administration_path(@zonalAdministration), notice: "Imagen añadida"
        else
          render :new
        end
    end
    ...
    def update
        ...
        if @houseImage.update(image_params)
            redirect_to housesadmin_zonal_administration_path(@zonalAdministration), notice: "Imagen actualizada"
        else
          render :edit
        end
    end
    ...
    def destroy
        ...
        redirect_to housesadmin_zonal_administration_path(@zonalAdministration), notice: "Imagen eliminada"
    end
