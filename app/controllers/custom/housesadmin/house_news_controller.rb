class Housesadmin::HouseNewsController < Housesadmin::BaseController
    ...
    def create
        ...
        if @houseNew.save
          redirect_to housesadmin_zonal_administration_path(@zonalAdministration), notice: "Noticia creada"
        else
          render :new
        end
    end
    ...
    def update
        ...
        if @houseNew.update(news_params)
            redirect_to housesadmin_zonal_administration_path(@zonalAdministration), notice: "Noticia actualizada"
        else
          render :edit
        end
    end
    ...
    def destroy
        ...
        redirect_to housesadmin_zonal_administration_path(@zonalAdministration), notice: "Noticia eliminada"
    end
