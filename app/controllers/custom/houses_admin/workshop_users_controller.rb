class HousesAdmin::WorkshopUsersController < HousesAdmin::BaseController
    ...
    def destroy
        ...
        redirect_to houses_admin_zonal_administration_house_workshop_path(@zonalAdministration, @house, @workshop),
    ...
    def update
        ...
        if @workshopUser.update(workshop_user_params)
          redirect_to houses_admin_zonal_administration_house_workshop_path(@zonalAdministration, @house, @workshop), notice: "estado actualizado"
        else
          render :edit
        end
    end
