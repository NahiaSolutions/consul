class HousesAdmin::WorkshopsController < HousesAdmin::BaseController
    ...
    def create
        ...
        if @workshop.save
          redirect_to houses_admin_zonal_administration_house_path(@zonalAdministration, @house), notice: "Taller creado"
        else
    ...
    def update
        ...
        if @workshop.update(workshop_params)
          redirect_to houses_admin_zonal_administration_house_path(@zonalAdministration, @house), notice: "casa actualizada"
        else
          render :edit
        end
    end
    ...
    def destroy
        ...
        redirect_to houses_admin_zonal_administration_house_path(@zonalAdministration, @house), notice: "Taller eliminado"
    end
