class HousesAdmin::ZonalAdministrationsController < HousesAdmin::BaseController
    ...
    def update
        ...
        if @zonalAdministration.update(zone_params)
          redirect_to houses_admin_zonal_administrations_path, notice: "administracion actualizada"
        else
          render :edit
        end
    end
    ...
    def create
        ...
        if @zonalAdministration.save
          redirect_to houses_admin_zonal_administrations_path, notice: "Administracion zonal creada"
        else
          render :new
        end
    end
    ...
    def destroy
        ...
        redirect_to houses_admin_zonal_administrations_path, notice: "Administracion zonal eliminada"
    end
